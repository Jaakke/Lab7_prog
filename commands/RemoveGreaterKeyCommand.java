...
public class RemoveGreaterKeyCommand implements Command {
    ...
    public RemoveGreaterKeyCommand(CollectionManager collectionManager, DatabaseManager databaseManager) {
    ...
    public Response execute(Request request) {
        ...
        try {
            ...
            if (keysToRemove.isEmpty()) {
                return new Response("Не найдено принадлежащих вам элементов с ключом больше " + targetKey + ".");
            }
    ...
    public String getDescription() {
        return "удалить из коллекции все элементы, ключ которых превышает заданный (только свои)";
    }
